// Copyright (c) 2014 The EuropeanPropertyCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("EuropeanPropertyCoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("EuropeanPropertyCoin-smsg-pow"); // Make this thread recognisable
