...
static const int LAST_POW_BLOCK = 11221200;
...
static const int64_t COIN_YEAR_REWARD = 17 * CENT; // 17% per year
...
static const uint256 hashGenesisBlock("0x00000f484d9f682c5818e376c9dffd86ec5c4b0eb72d4ac7b59122bd108cd951");
static const uint256 hashGenesisBlockTestNet("0x0000910a87c1385247edc82808ec498a2d738fea5f0d3f8801512d6b84ad6f72");


inline int64_t PastDrift(int64_t nTime)   { return nTime - 1 * 60 * 60; } // up to 10 minutes from the past
inline int64_t FutureDrift(int64_t nTime) { return nTime + 1 * 60 * 60; } // up to 10 minutes from the future
