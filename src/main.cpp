...
const string strMessageMagic = "EuropeanPropertyCoin Signed Message:\n";
...
static const int64_t nTargetTimespan = 1 * 60;  // 1 mins
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EuropeanPropertyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "China to build atoll with airstrip in South China Seal -- GNews";
        CTransaction txNew;
        txNew.nTime = 1463212743;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1463212743;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
       // block.nNonce   = !fTestNet ? 666415 : 55887;
        block.nNonce = 214947;
        ...
        assert(block.hashMerkleRoot == uint256("0x7906f40ab89403cb1606835d1ec2b45def366a4707a74a92916515a87e8c6795"));
